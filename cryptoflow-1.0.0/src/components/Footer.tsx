        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#!"
                  className="text-gray-400 hover:text-crypto-purple transition-colors cursor-pointer"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#!" className="text-gray-400 hover:text-crypto-purple transition-colors">Deepfake Insights</a></li>
